...
export default function ProjectGrid({ initialProjects }: ProjectGridProps) {
  ...
  return (
    <>
      {sortProjs(projects).slice(0, 5).map((project) => (
        <Link
          ...
          className="group rounded-[12px] bg-black overflow-hidden relative flex flex-col md:block h-auto md:h-[340px] lg:h-[calc((100svh-88px)/2)] lg:min-h-[360px] transition-all duration-300 hover:shadow-[0_0_40px_rgba(255,255,255,0.05)] border border-white/10 md:border-0"
        >
